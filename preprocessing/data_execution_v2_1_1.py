...
from main_preprocessing_mgp_tcn_v2_1_1 import load_data

# MGP-TCN 데이터 전처리 코드만 실행하는 실행 코드
if __name__ == '__main__':
    """
    # Data Imputation Code (데이터 결측치 처리 코드)
    # RNN 기반 GRU-D 데이터 결측치 보강         : 1_1_gru_d
    # Data Imputation using RNN based GRU-D : 1_1_gru_d 
    """
    ...
    output_path = "/output_imputation/output_1/"

    print(root_path)
    # 실험 종류 정의 (GRU-D 알고리즘 적용 코드)
    experiment_type = '1_1_gru_d'
