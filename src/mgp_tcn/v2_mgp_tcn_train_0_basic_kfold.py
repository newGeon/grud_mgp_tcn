...
ex = Experiment('V2_MGP-TCN-0-BASIC-KFOLD')
...
def mpg_tcn_config():
    dataset = {
        ...
        'datapath': 'output_imputation/output_0_kfold_5/',
        ...
        'num_obs_thres': None,      # None, Min and Max number of values (patients with 0 values appear due to control matching, drop controls with no values..) currently, 10k drops 1 patient, this is for memory saving.
        'split': 0,                 # 0-4
        'root_path': '/home/cdss/grud_mgp_tcn/',
        'LOG_FILE': 'v2_0_basic_1_55h_ex1c.txt',
        'hour': '55h',
        'kind': 'ex1c'
    }
    # Padding method:
...
def fit_mgp_tcn(decomposition_method, add_diag, losstype, n_hidden, levels, kernel_size, n_mc_smps, dropout,
    ...
    checkpoint_path = dataset['root_path'] + 'model_v2/checkpoints_0_basic_kfold'
    if not os.path.isdir(checkpoint_path):
        os.mkdir(checkpoint_path)

    checkpoint_path = checkpoint_path + '/' + checkpoint_folder

    result_image_path = dataset['root_path'] + 'model_v2/result_image_0_basic_kfold'
    print("---------------------------------------------------------------------------------------------------")
